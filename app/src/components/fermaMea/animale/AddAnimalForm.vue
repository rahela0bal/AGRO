...
<template>
  <div class="add-form">
    ...
    <input
      v-model="localAnimal.categorie"
      placeholder="Categorie (ex: Vaci)"
    ...
    >
    <input
      v-model="localAnimal.obiectiv"
      placeholder="Obiectiv (ex: Lapte)"
      class="input text-gray-900"
    >
    <button
      class="btn-save"
      @click="handleSave"
    >
      <i class="bi bi-check-circle" /> Salvează
    </button>
  </div>
</template>
